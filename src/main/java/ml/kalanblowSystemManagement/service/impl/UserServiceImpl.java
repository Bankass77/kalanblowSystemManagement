...
public class UserServiceImpl implements UserService {
    ...
    public UserDto findUserById(Long id) {
        ...
        User user = userRepository.findUserById(id).orElseThrow(() -> exception(EntityType.USER,
                ExceptionType.ENTITY_NOT_FOUND, "Invalid user Id:" + id));
    ...
    public Optional<UserDto> findUserByfirstNameAndLastName(String firstName, String lastName) {
        ...
        if (firstName != null && lastName != null) {
            ...
            log.debug("findUserByfirstNameAndLastName:{}",
                    Optional.ofNullable(modelMapper.map(
    ...
    public Optional<UserDto> findUserByRoles(UserRole name) {
        ...
        if (name != null) {
            return Optional.ofNullable(
                    modelMapper.map(userRepository.findUserByRoles(name), UserDto.class));
        }
    ...
    public UserDto deleteUserById(Long id) {
        ...
        if (id != null) {
            return Optional
                    .ofNullable(modelMapper.map(userRepository.deleteUserById(id), UserDto.class))
                    .get();
        }
    ...
    public UserDto deleteUserByEmail(String email) {
        ...
        if (email != null) {
            return Optional
                    .ofNullable(
                            modelMapper.map(userRepository.deleteUserByEmail(email), UserDto.class))
                    .get();
        }
    ...
    public Page<UserDto> listUserByPage(Pageable pageable) {
        ...
        if (!users.isEmpty()) {
            ...
            return new PageImpl<UserDto>(userDtos.subList(start, end), pageable,
    ...
    public Set<UserDto> findUserByLastName(String lastName) {
        ...
        List<User> users =
                userRepository.findAllByLastNameContainingIgnoreCaseOrderByIdAsc(lastName);
    ...
    public Page<UserDto> findAllPageableOrderByLastName(String queryString, Pageable pageable) {
        ...
        return new PageImpl<>(
                uPage.stream().map(userDto -> new UserDto()).collect(Collectors.toList()), pageable,
                totalElements);
    }
    ...
    private boolean isGeoIpLibEnabled() {
        return Boolean
                .parseBoolean(propertiesConfig.getConfigValue("geo.ip.lib.enabled").toString());
    }
    ...
    public Page<UserDto> findAllPageable(PageRequest of) {
        ...
        List<UserDto> userDtos =
                users.stream().map(userDto -> modelMapper.map(userDto, UserDto.class))
                        .collect(Collectors.toList());
    ...
    public Page<UserDto> findByIdPageable(Long id, Pageable pageRequest) {
        ...
        Optional<UserDto> uOptional =
                Optional.ofNullable(UserMapper.userToUserDto(userRepository.findById(id).get()));
