...
public class Student extends User {
	...
	@Column(name = "age")
	@PositiveOrZero(message = "You cannot have negative numbers of age.")
	private int age;


	@Column(name = "studentNumeroIne")
	...
	@Pattern(regexp = "^[12][0-9]{3}$", message = "le format de l'année scolaire est de 4 chiffres, ex 2021")
	@NotNull(message = "le format de l'année scolaire est de 4 chiffres, ex 2021")
