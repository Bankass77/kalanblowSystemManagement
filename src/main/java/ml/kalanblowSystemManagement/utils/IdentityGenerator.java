...
/**
 * Database agnostic unique ID generator inspired by <a href=
 ...
 * <li>the next 40 bits represent the elapsed milliseconds from a custom Epoch
 * (2017-02-20)
 * <li>the next 16 bits represent a serial number XOR-ed with a per-thread
 * random number
 * </ul>
 *
 * <p>
 * With this technique 65536 unique IDs can be generated per shard per
 * millisecond.
 */
...
public final class IdentityGenerator {
	...
	/**
	 * Custom Epoch (2021-08-11).
	 */
	public static final Instant EPOCH = LocalDateTime.of(2021, 8, 11, 0, 0, 0, 0).toInstant(UTC);
