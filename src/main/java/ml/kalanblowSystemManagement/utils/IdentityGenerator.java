 ...
 * <a href= "https://engineering.instagram.com/sharding-ids-at-instagram-1cf5a71e5a5c"> Sharding &
 * IDs at Instagram</a>
 *
 * <p>
...
public final class IdentityGenerator {
    ...
    static {
        THREAD_LOCAL_SERIAL = ThreadLocal
                .withInitial(() -> new Serial(RandomUtil.nextInt(), RandomUtil.nextInt()));
    }
