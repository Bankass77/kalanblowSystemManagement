 ...
 * org.junit.jupiter.api.Disabled; import org.junit.jupiter.api.DisplayName;
 ...
 * ml.kalanblowSystemManagement.repository.RoleRepository; import
 * ml.kalanblowSystemManagement.repository.UserRepository; import
 * ml.kalanblowSystemManagement.service.UserService; import static
 * org.assertj.core.api.Java6Assertions.assertThat; //import static
 ...
 * 
 * @Transactional class UserServiceImplTest {
 * 
 ...
 * 
 * @InjectMocks UserService userService = new UserServiceImpl(userRepository,
 * roleRepository, modelMapper, passwordEncoder, null, null, null);
 * 
 * @BeforeEach void initUseCase() {
 * 
 * userService = new UserServiceImpl(userRepository, roleRepository,
 * modelMapper, passwordEncoder, null, null, null); }
 * 
 * @Test void testSignup() {
 * 
 * UserDto userDto = new
 * UserDto().setAdmin(true).setEmail("admin2@example.com").setFirstName(
 * "admin2")
 ...
 * 
 * UserDto saveUser = userService.signup(userDto); assertAll("userDto", () ->
 * assertThat(saveUser.getFullName()).isNotNull()); }
 * 
 * }
 */